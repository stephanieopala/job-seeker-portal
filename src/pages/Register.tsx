        ...
        <div className="w-full h-full flex flex-col justify-center items-center mb-10">
          <Card className="border-dark-gray w-1/2">
                    ...
                    <FormItem className="mt-4">
                      ...
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        ...
                        <SelectContent className="border-dark-gray">
                          <SelectItem value="jobSeeker" className="hover:bg-light-gray cursor-pointer">Job Seeker</SelectItem>
                          <SelectItem value="employer" className="hover:bg-light-gray cursor-pointer">Employer</SelectItem>
                        </SelectContent>
                      </Select>
                      <FormMessage className="text-error"/>
                    </FormItem>
            ...
            <CardFooter className="flex justify-end">
              ...
              <Button onClick={form.handleSubmit(onSubmit)} className="bg-primary text-white hover:bg-primary-dark">Register</Button>
            </CardFooter>
          </Card>
        </div>
      <Footer />
